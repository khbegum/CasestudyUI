...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsGadgetEditGadgetEditComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsMusicGadgetsMusicGadgetsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsPaymentDialogPaymentDialogComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsThankDiaogThankDiaogComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
        ...
        value: function ngOnInit() {
          ...
          this.cartService.getCart().subscribe(function (data) {
            ...
            for (var i = 0; i < _this.carts.length; i++) {
              _this.count = _this.count + _this.carts[i].productCount;
            }
          });
          this.coins;
          this.cash;
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_music_gadgets_music_gadgets_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./components/music-gadgets/music-gadgets.component */
    ...
    var _app_services_auth_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ../app/services/auth.service */
    "./src/app/services/auth.service.ts");
    /* harmony import */


    var _app_services_register_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    ...
    var _services_gadget_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./services/gadget.service */
    "./src/app/services/gadget.service.ts");
    /* harmony import */


    var _components_gadget_edit_gadget_edit_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./components/gadget-edit/gadget-edit.component */
    "./src/app/components/gadget-edit/gadget-edit.component.ts");
    /* harmony import */


    var _components_cart_cart_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    ...
    var _components_payment_dialog_payment_dialog_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./components/payment-dialog/payment-dialog.component */
    "./src/app/components/payment-dialog/payment-dialog.component.ts");
    /* harmony import */


    var _shared_material_module__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./shared/material.module */
    "./src/app/shared/material.module.ts");
    /* harmony import */


    var _components_thank_diaog_thank_diaog_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./components/thank-diaog/thank-diaog.component */
    "./src/app/components/thank-diaog/thank-diaog.component.ts");
    /* harmony import */


    var _guards_employee_guard__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./guards/employee.guard */
    ...
    var appRoutes = [{
      ...
      path: 'gadgets',
      component: _components_music_gadgets_music_gadgets_component__WEBPACK_IMPORTED_MODULE_8__["MusicGadgetsComponent"],
      canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_15__["AuthGuard"]],
      canActivateChild: [_guards_employee_guard__WEBPACK_IMPORTED_MODULE_25__["EmployeeGuard"]]
    }, {
      path: 'login',
      ...
      path: 'edit/:_id',
      component: _components_gadget_edit_gadget_edit_component__WEBPACK_IMPORTED_MODULE_17__["GadgetEditComponent"]
    }, {
      path: 'payment',
      component: _components_payment_dialog_payment_dialog_component__WEBPACK_IMPORTED_MODULE_22__["PaymentDialogComponent"]
    }, {
      path: 'cart',
      component: _components_cart_cart_component__WEBPACK_IMPORTED_MODULE_18__["CartComponent"]
    }, {
      path: 'cart/:_id',
      component: _components_cart_cart_component__WEBPACK_IMPORTED_MODULE_18__["CartComponent"]
    }];
  ...
  function srcAppComponentsCartCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_gadget_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! src/app/services/gadget.service */
    "./src/app/services/gadget.service.ts");

    var CartComponent = /*#__PURE__*/function () {
      function CartComponent(cartService, gadgetService, router, activatedRoute) {
      ...
      _createClass(CartComponent, [{
        ...
        key: "getCartFromSerive",
        value: function getCartFromSerive() {
          var _this2 = this;

          this.cartService.getCart().subscribe(function (response) {
            _this2.carts = response;
            _this2.count = _this2.carts.length;
          });
        }
      }, {
        key: "deleteGadgetFromCart",
        value: function deleteGadgetFromCart(gadget) {
          var _this3 = this;

          this.cartService.deleteGadgetFromCart(gadget).subscribe(function (result) {
            alert('deleted');

            _this3.getCartFromSerive();
          });
        }
      }, {
        key: "buy",
        ...
        key: "editProductCount",
        value: function editProductCount(id) {
          var _this4 = this;

          this.key = id;
          this.cartService.getGadgetById(id).subscribe(function (response) {
            console.log(response);
            _this4.cartEdit = response;
          });
          this.gadgetService.getGadgetById(id).subscribe(function (res) {
            _this4.gadget = res;
          });
        ...
        value: function save() {
          ...
          if (this.gadget.productCount >= this.cartEdit.productCount) {
            this.cartService.updateGadgetById(this.cartEdit._id, this.cartEdit).subscribe(function (response) {
              _this5.enable = false;

              _this5.getCartFromSerive();
  ...
  /***/
  function srcAppComponentsGadgetEditGadgetEditComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsGadgetEditGadgetEditComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GadgetEditComponent", function () {
      return GadgetEditComponent;
    });
    /* harmony import */
    ...
    var src_app_services_gadget_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! src/app/services/gadget.service */
    "./src/app/services/gadget.service.ts");

    var GadgetEditComponent = /*#__PURE__*/function () {
      //gadgets:Gadget[]=[];
      function GadgetEditComponent(router, activatedRoute, gadgetService) {
        _classCallCheck(this, GadgetEditComponent);
      ...
      _createClass(GadgetEditComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this6 = this;

          var id = this.activatedRoute.snapshot.paramMap.get('_id');
          this.gadgetService.getGadgetById(id).subscribe(function (response) {
            console.log(response);
            _this6.gadgets = response;
          });
        }
      }, {
        key: "save",
        value: function save() {
          ...
          this.gadgetService.updateGadgetById(this.gadgets._id, this.gadgets).subscribe(function (response) {
            _this7.router.navigate(['/gadgets']);
          });
        }
      }, {
        key: "cancel",
    ...
    GadgetEditComponent.ctorParameters = function () {
      return [{
    ...
    GadgetEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-gadget-edit',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./gadget-edit.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/gadget-edit/gadget-edit.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./gadget-edit.component.css */
      "./src/app/components/gadget-edit/gadget-edit.component.css"))["default"]]
    })], GadgetEditComponent);
    /***/
  },
  ...
  function srcAppComponentsHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(router, authService, registerService, activatedRoute, gadgetService, cartService) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.registerService.getUserById(id).subscribe(function (response) {
            console.log(response);
            _this8.users = response;
          });
          this.getGadgetsFromService();
        }
      }, {
        key: "addCartToService",
        value: function addCartToService(_id, name, type, colour, cost, poster, description, productCount) {
          var _this9 = this;

          if (this.authService.isLoggedIn()) {
            this.cartService.addCart(_id, name, type, colour, cost, poster, description, productCount).subscribe(function (response) {
              _this9.result = response;
            });
            this.gadgetService.getGadgetById(_id).subscribe(function (res) {
              _this9.gadget = res;
            });
          } else {
            this.router.navigate(['/login']);
        ...
        key: "getGadgetsFromService",
        value: function getGadgetsFromService() {
          var _this10 = this;

          this.gadgetService.getGadgets().subscribe(function (response) {
            _this10.gadgets = response;
          });
        }
      }]);
  ...
  function srcAppComponentsLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_shared_alert_alert_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/shared/alert/alert.service */
    "./src/app/shared/alert/alert.service.ts");

    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(authService, router, registerService, alertService) {
  ...
  /***/
  function srcAppComponentsMusicGadgetsMusicGadgetsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsMusicGadgetsMusicGadgetsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MusicGadgetsComponent", function () {
      return MusicGadgetsComponent;
    });
    /* harmony import */
    ...
    var src_app_services_gadget_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/services/gadget.service */
    "./src/app/services/gadget.service.ts");
    /* harmony import */
    ...
    var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! @angular/forms */
    "./node_modules/@angular/forms/fesm2015/forms.js"); //import { FormBuilder } from '@angular/forms';


    var MusicGadgetsComponent = /*#__PURE__*/function () {
      function MusicGadgetsComponent(gadgetService, formBuilder, router) {
        _classCallCheck(this, MusicGadgetsComponent);
      ...
      _createClass(MusicGadgetsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.getGadgetsFromService();
        }
        ...
        value: function getGadgetsFromService() {
          ...
          this.gadgetService.getGadgets().subscribe(function (response) {
            _this12.gadgets = response;
            console.log(_this12.gadgets);
          });
        }
      }, {
        key: "addGadgetToServices",
        value: function addGadgetToServices(name, type, colour, cost, poster, description, productCount) {
          var _this13 = this;

          this.gadgetService.addGadget(name, type, colour, cost, poster, description, productCount).subscribe(function (response) {
            alert('Gadget is added'); //this.getGadgetsFromService();

            _this13.router.navigate(['']);
          });
        }
      }, {
        key: "deleteGadgetFromService",
        value: function deleteGadgetFromService(gadget) {
          var _this14 = this;

          // alert(gadget._id);
          this.gadgetService.deleteGadget(gadget).subscribe(function (response) {
            alert('Data Deleted');

            _this14.getGadgetsFromService();
          });
        }
      }, {
        key: "goToEditComponent",
        value: function goToEditComponent(id) {
    ...
    MusicGadgetsComponent.ctorParameters = function () {
      return [{
    ...
    MusicGadgetsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-music-gadgets',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./music-gadgets.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/music-gadgets/music-gadgets.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./music-gadgets.component.css */
      "./src/app/components/music-gadgets/music-gadgets.component.css"))["default"]]
  ...
  /***/
  function srcAppComponentsPaymentDialogPaymentDialogComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsPaymentDialogPaymentDialogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _thank_diaog_thank_diaog_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../thank-diaog/thank-diaog.component */
    "./src/app/components/thank-diaog/thank-diaog.component.ts");
    /* harmony import */
    ...
    var src_app_services_gadget_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/services/gadget.service */
    "./src/app/services/gadget.service.ts");

    var PaymentDialogComponent = /*#__PURE__*/function () {
      function PaymentDialogComponent(cartService, dialog, router, gadgetService) {
      ...
      _createClass(PaymentDialogComponent, [{
        ...
        key: "getCartFromService",
        value: function getCartFromService() {
          var _this15 = this;

          this.cartService.getCart().subscribe(function (response) {
            _this15.carts = response;

            for (var i = 0; i < _this15.carts.length; i++) {
              _this15.sum = _this15.sum + _this15.carts[i].cost * _this15.carts[i].productCount;
            }
          });
        }
      }, {
        ...
        value: function save() {
          ...
          var dialogref = this.dialog.open(_thank_diaog_thank_diaog_component__WEBPACK_IMPORTED_MODULE_4__["ThankDiaogComponent"], {
            width: '450px'
          });

          var _loop = function _loop(i) {
            _this16.cartService.deleteGadgetFromCart(_this16.carts[i]).subscribe(function (res) {
              console.log(_this16.carts[i]._id);
            });

            _this16.gadgetService.getGadgetById(_this16.carts[i]._id).subscribe(function (res) {
              _this16.gadget = res;
              console.log(_this16.gadget.productCount);
              _this16.gadget.productCount = _this16.gadget.productCount - _this16.carts[i].productCount;
              console.log(_this16.gadget.productCount);

              _this16.gadgetService.updateGadgetById(_this16.gadget._id, _this16.gadget).subscribe(function (res) {
                console.log(res);
              });
            });
          };
    ...
    PaymentDialogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/payment-dialog/payment-dialog.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./payment-dialog.component.css */
      "./src/app/components/payment-dialog/payment-dialog.component.css"))["default"]]
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegisterComponent = /*#__PURE__*/function () {
      function RegisterComponent(registerService, authService, router, formBuilder) {
      ...
      _createClass(RegisterComponent, [{
        ...
        key: "addUserToServices",
        value: function addUserToServices(name, email, type, password) {
          var _this17 = this;

          // alert(name)
          this.registerService.addUser(name, email, type, password).subscribe(function (res) {
  ...
  /***/
  function srcAppComponentsThankDiaogThankDiaogComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsThankDiaogThankDiaogComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ThankDiaogComponent", function () {
      return ThankDiaogComponent;
    });
    /* harmony import */
    ...
    var ThankDiaogComponent = /*#__PURE__*/function () {
      function ThankDiaogComponent(router, dialogRef) {
        _classCallCheck(this, ThankDiaogComponent);

        this.router = router;
        this.dialogRef = dialogRef;
      }

      _createClass(ThankDiaogComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "thankyou",
    ...
    ThankDiaogComponent.ctorParameters = function () {
      return [{
        type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]
      }, {
    ...
    ThankDiaogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-thank-diaog',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./thank-diaog.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/thank-diaog/thank-diaog.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./thank-diaog.component.css */
      "./src/app/components/thank-diaog/thank-diaog.component.css"))["default"]]
    })], ThankDiaogComponent);
    /***/
  },
  ...
  /***/
  function srcAppGuardsEmployeeGuardTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "EmployeeGuard", function () {
    ...
    var EmployeeGuard = /*#__PURE__*/function () {
      function EmployeeGuard(authService) {
        _classCallCheck(this, EmployeeGuard);

        this.authService = authService;
      }

      _createClass(EmployeeGuard, [{
    ...
    EmployeeGuard.ctorParameters = function () {
      return [{
        type: _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
      }];
    };

    EmployeeGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], EmployeeGuard);
    /***/
  },
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        key: "signInUser",
        value: function signInUser(loginInfo) {
  ...
  function srcAppServicesCartServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CartService = /*#__PURE__*/function () {
      ...
      _createClass(CartService, [{
        key: "addCart",
        value: function addCart(_id, name, type, colour, cost, poster, description, productCount) {
          var newCart = {
            _id: _id,
            name: name,
            type: type,
        ...
        key: "getGadgetById",
        value: function getGadgetById(_id) {
          return this.http.get(this.serviceUrl + _id);
        }
      }, {
        key: "deleteGadgetFromCart",
        value: function deleteGadgetFromCart(cart) {
          return this.http["delete"](this.serviceUrl + cart._id);
        }
      }, {
        key: "updateGadgetById",
        value: function updateGadgetById(id, newCart) {
  ...
  /***/
  function srcAppServicesGadgetServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "GadgetService", function () {
    ...
    var GadgetService = /*#__PURE__*/function () {
      function GadgetService(http) {
        _classCallCheck(this, GadgetService);
      ...
      _createClass(GadgetService, [{
        ...
        key: "updateGadgetById",
        value: function updateGadgetById(id, newGadget) {
          console.log(newGadget);
          return this.http.put(this.serviceUrl + id, newGadget);
        }
      }, {
        key: "addGadget",
        value: function addGadget(name, type, colour, cost, poster, description, productCount) {
          alert(name);
          var newGadget = {
            name: name,
            type: type,
        ...
        key: "deleteGadget",
        value: function deleteGadget(gadget) {
          alert(gadget._id);
    ...
    GadgetService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    GadgetService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], GadgetService);
    /***/
  },
  ...
  function srcAppServicesRegisterServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegisterService = /*#__PURE__*/function () {
      ...
      _createClass(RegisterService, [{
        key: "getUserById",
        value: function getUserById(_id) {
          return this.http.get(this.serviceUrl + _id);
        }
      }, {
        key: "addUser",
        value: function addUser(name, email, type, password) {
          var newUser = {
            name: name,
            email: email,
            type: type,
  ...
  /***/
  function srcAppSharedAlertModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(AlertComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.alertSubscription = this.alertService.onAlert(this.id).subscribe(function (alert) {
            ...
            if (!alert.message) {
              ...
              _this18.alerts = _this18.alerts.filter(function (x) {
                return x.keepAfterRouteChange;
              }); // remove 'keepAfterRouteChange' flag on the rest

              _this18.alerts.forEach(function (x) {
            ...
            _this18.alerts.push(alert); // auto close alert if required


            if (alert.autoClose) {
              setTimeout(function () {
                return _this18.removeAlert(alert);
              }, 3000);
            }
          ...
          this.routeSubscription = this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationStart"]) {
              _this18.alertService.clear(_this18.id);
            }
          });
        }
      }, {
        ...
        value: function removeAlert(alert) {
          ...
          if (this.fade) {
            ...
            setTimeout(function () {
              _this19.alerts = _this19.alerts.filter(function (x) {
                return x !== alert;
              });
            }, 250);
          } else {
  ...
  /***/
  function srcAppSharedAlertAlertModelTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\karim\OneDrive\Documents\CaseStudy\musicAngularApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
